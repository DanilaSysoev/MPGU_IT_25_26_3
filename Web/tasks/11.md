## Web 10. Основы PostgreSQL (максимальный балл 10, дедлай 25.11.2025 включительно)
...
CREATE TABLE deliveries (
  ...
  city            TEXT         NOT NULL CHECK(realm in ('Stockholm', 'Gothenburg', 'Malmo', 'Uppsala')),
  platform        TEXT         NOT NULL CHECK(realm in ('ios', 'android', 'web')),
  cuisine         TEXT         NOT NULL CHECK(realm in ('pizza', 'sushi', 'burger', 'salad', 'indian')),
  payment_method  TEXT         NOT NULL CHECK(realm in ('card', 'cash', 'wallet')),
  status          TEXT         NOT NULL CHECK(realm in ('placed', 'accepted', 'delivered', 'cancelled', 'refunded')),
